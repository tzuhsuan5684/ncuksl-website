...
export default function Team() {
    ...
    const renderMemberCard = (member) => {
        ...
        return (
            <div className="group glass-card text-center p-6 rounded-2xl flex flex-col h-full bg-white dark:bg-secondary-800">
                <div className="w-32 h-32 rounded-full mx-auto mb-6 shadow-md overflow-hidden border-4 border-secondary-50 dark:border-secondary-700/50 group-hover:border-primary-100 dark:group-hover:border-primary-900/50 transition-colors duration-300">
                    <img src={`/${member.image}`} alt={member.name} className={`w-full h-full object-cover ${positionClass}`} />
                </div>
    ...
    const renderAlumniCard = (member) => {
        return (
            <div className="group relative glass-card rounded-2xl p-6 overflow-hidden">
